...
server:
	...
	g++ $(source) -I./3rdparty/luasrc/src -I./3rdparty/lua_tinker/ -I./3rdparty/accumulation-dev/src/net -I./3rdparty/accumulation-dev/src/timer -I./3rdparty/accumulation-dev/src/utils -O3 -std=c++11 -L./ -llua -lpthread -lrt -Wl,-rpath=./ -o dbproxy
